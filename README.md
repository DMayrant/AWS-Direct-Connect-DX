# ☁️ AWS Direct Connect DX

AWS Direct Connect allows on-premise data centers to connect to the AWS cloud to achieve additional resource capacity. This will allow companies to work as a hybrid and multi-cloud environment. 
...
4. improved data distribution

5. Archives and data retention

6. Removed legacy infrastructure dependence 
